  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="{{route('penjual.dashboard') == url()->current() ? '#' : route('penjual.dashboard')}}" class="list-group-item list-group-item-action bg-light {{route('penjual.dashboard') == url()->current() ? 'text-primary font-weight-bold' : route('penjual.dashboard')}}"> <i class="fa fa-list"></i> Permintan</a>
