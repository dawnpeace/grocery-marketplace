...
@section('breadcrumb')
    <nav class="breadcrumb mt-4">
        ...
        <span class="breadcrumb-item active">Tambah Pasar</span>
    </nav>
@endsection
...
@section('content')
    ...
    <div class="py-3">
        <div class="card">
            <div class="card-body">
                <h2><i class="fa fa-map"></i> Tambah Pasar</h2>
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="border border-secondary d-flex rounded">
                                <img id="img-show" src="" alt="" class="img img-fluid m-auto">
                            </div>
