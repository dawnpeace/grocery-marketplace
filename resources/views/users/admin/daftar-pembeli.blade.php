        ...
        <table class="table table-sm table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$user->email}}</td>
                    <td>
                        <a href="{{route('edit.pembeli',[$user->pembeli->id])}}" class="btn btn-sm btn-primary">Perbaharui <i class="fas fa-pencil-alt"></i></a>
                        <button data-url="{{route('verif.pembeli',[$user->pembeli->id])}}" class="btn btn-sm btn-verif {{$user->pembeli['telah_diverifikasi'] ? 'btn-danger' : 'btn-success'}}">{{$user->pembeli['telah_diverifikasi'] ? 'Batal' : 'Verif'}} <i class="{{$user->pembeli['telah_diverifikasi'] ? 'far fa-window-close' : 'fa fa-check'}}"></i></button>
                    </td>
                @php $i++; @endphp
                </tr>
                @endforeach
